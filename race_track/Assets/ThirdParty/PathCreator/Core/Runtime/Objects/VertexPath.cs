...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public int GetPreviousSegmentIndexAtDistance(float dst, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop)
        {
            float t = dst / length;
            return GetPreviousSegmentIndexAtTime(t, endOfPathInstruction);
        }
        ...
        public int GetPreviousSegmentIndexAtTime(float t, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop)
        {
        ...
        public int GetClosestPreviousSegmentIndexOnPath(Vector3 worldPoint)
        {
